 ...
 * @author jackie
 */
public class SocketClientDeviceListActivity extends BaseAppCompatActivity {

    /*---------------------------静态常量---------------------------*/

    private static final String TAG= SocketClientDeviceListActivity.class.getSimpleName();
    ...
    private BaseQuickAdapter.OnItemClickListener onItemClickListener = new BaseQuickAdapter.OnItemClickListener() {
        ...
        public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
            ...
            Intent intent = new Intent(SocketClientDeviceListActivity.this, SocketClientActivity.class);
    ...
    protected int setLayout() {
        return R.layout.activity_socket_client_device_list;
    }
    ...
    private void initBluetoothScanner() {
        classicBluetoothScanner = ClassicBluetoothManager.getBluetoothScannerInstance(SocketClientDeviceListActivity.this);
        if (classicBluetoothScanner == null) {
            return;
        }
    ...
    private void initRecyclerViewData() {
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(SocketClientDeviceListActivity.this);
