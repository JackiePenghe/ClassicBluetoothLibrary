 ...
 * @author jackie
 */
public class A2dpDeviceListActivity extends BaseAppCompatActivity {

    /*---------------------------静态常量---------------------------*/

    private static final String TAG= A2dpDeviceListActivity.class.getSimpleName();
    /*---------------------------成员变量---------------------------*/
    ...
    private BaseQuickAdapter.OnItemClickListener onItemClickListener = new BaseQuickAdapter.OnItemClickListener() {
        ...
        public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
            ...
            Intent intent = new Intent(A2dpDeviceListActivity.this, A2dpActivity.class);
    ...
    protected int setLayout() {
        return R.layout.activity_a2dp_device_list;
    }
    ...
    private void initBluetoothScanner() {
        classicBluetoothScanner = ClassicBluetoothManager.getBluetoothScannerInstance(A2dpDeviceListActivity.this);
        if (classicBluetoothScanner == null) {
            return;
        }
    ...
    private void initRecyclerViewData() {
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(A2dpDeviceListActivity.this);
