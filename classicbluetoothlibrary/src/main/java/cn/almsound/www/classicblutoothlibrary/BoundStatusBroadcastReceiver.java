...
public class BoundStatusBroadcastReceiver extends BroadcastReceiver {

    /*------------------------静态常量----------------------------*/

    private static final String TAG = BoundStatusBroadcastReceiver.class.getSimpleName();
    /**
    ...
    private ClassicBluetoothInterface.OnDeviceBondStateChangedListener mOnDeviceBondStateChangedListener;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        switch (action) {
            ...
            case BluetoothDevice.ACTION_BOND_STATE_CHANGED:
                Tool.warnOut("BoundStatusBroadcastReceiver", "ACTION_BOND_STATE_CHANGED");
                int bondState = intent.getIntExtra(BluetoothDevice.EXTRA_BOND_STATE, BluetoothDevice.ERROR);
                Tool.warnOut("BoundStatusBroadcastReceiver", "bondState = " + bondState);
                switch (bondState) {
                    case BluetoothDevice.BOND_BONDING:
                        Tool.warnOut("BoundStatusBroadcastReceiver", "BOND_BONDING");
                        if (mOnDeviceBondStateChangedListener != null) {
                            mOnDeviceBondStateChangedListener.onDeviceBinding();
                        }
                        break;
                    case BluetoothDevice.BOND_BONDED:
                        Tool.warnOut("BoundStatusBroadcastReceiver", "BOND_BONDED");
                        if (mOnDeviceBondStateChangedListener != null) {
                            mOnDeviceBondStateChangedListener.onDeviceBonded();
                        }
                        break;
                    case BluetoothDevice.BOND_NONE:
                        Tool.warnOut("BoundStatusBroadcastReceiver", "BOND_NONE");
                        if (mOnDeviceBondStateChangedListener != null) {
     ...
     */
    void setOnDeviceBondStateChangedListener(ClassicBluetoothInterface.OnDeviceBondStateChangedListener onDeviceBondStateChangedListener) {
